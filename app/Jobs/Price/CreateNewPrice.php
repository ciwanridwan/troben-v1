...
class CreateNewPrice
{
    ...
    public function __construct($inputs = [])
    {
        ...
        $this->attributes = Validator::make($inputs, [
            ...
            // 'origin_district_id' => ['required','exists:geo_districts,id'],
            // 'origin_sub_district_id' => ['required','exists:geo_sub_districts,id'],
            'destination_id' => ['required','exists:geo_sub_districts,id'],
            'zip_code' => ['required','exists:geo_districts,zip_code'],
