...
class UpdateExistingPrice
{
    ...
    public function __construct(Price $price, $inputs = [])
    {
        ...
        $this->attributes = Validator::make($inputs, [
            ...
            // 'origin_district_id' => ['filled','exists:geo_districts,id'],
            // 'origin_sub_district_id' => ['filled','exists:geo_sub_districts,id'],
            'destination_id' => ['filled','exists:geo_sub_districts,id'],
            'zip_code' => ['filled','exists:geo_districts,zip_code'],
            'service_code' => ['filled'],
