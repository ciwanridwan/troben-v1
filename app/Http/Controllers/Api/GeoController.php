...
class GeoController extends Controller
{
    ...
    protected function getSubDistrictsList(): JsonResponse
    {
        ...
        $query = SubDistrict::query()
            ...
            ->select('geo_regencies.name as regency', 'geo_regencies.id as regency_id', 'geo_districts.name as district', 'geo_districts.id as district_id', 'geo_sub_districts.name as sub_district', 'geo_sub_districts.id')
