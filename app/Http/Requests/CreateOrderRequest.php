...
class CreateOrderRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'destination_regency_id' => ['required', 'string', 'exists:geo_regencies,id'],
            'destination_district_id' => ['required', 'string', 'exists:geo_districts,id'],
            'destination_sub_district_id' => ['required', 'string', 'exists:geo_sub_districts,id'],
